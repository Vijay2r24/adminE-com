...
import { Search, Plus, MoreVertical, Mail, Phone, MapPin, Shield, UserPlus } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <div>
          ...
          <p className="text-gray-500">Manage your team members and their account permissions</p>
        </div>
        <button 
