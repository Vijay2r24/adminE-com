...
const Notifications = () => {
  ...
  const [silentFormData, setSilentFormData] = useState({
    componentName: '',
    json: ''
  });

  const [componentNotifications] = useState([
    {
      id: 1,
      componentId: 'CMP001',
  ...
  const handlePushSubmit = (e) => {
    ...
    console.log('Push notification submitted:', pushFormData);
  };
  ...
  const handleSilentSubmit = (e) => {
    ...
    console.log('Silent notification submitted:', silentFormData);
  };
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div className="flex items-center gap-3">
              <div className="p-2 bg-white/80 rounded-lg">
                <Bell className="h-6 w-6 text-[#5B45E0]" />
              </div>
      ...
      {activeTab === 'push' && (
        <form onSubmit={handlePushSubmit} className="space-y-8">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <div className="px-6 py-4 bg-gradient-to-r from-gray-50 to-white border-b border-gray-100">
              <h2 className="text-lg font-semibold text-gray-900 flex items-center gap-2">
                <Send className="h-5 w-5 text-[#5B45E0]" />
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-[#5B45E0] focus:border-[#5B45E0] sm:text-sm transition-colors duration-200"
          ...
          <div className="flex justify-end space-x-4">
            ...
            <button
              type="submit"
              className="px-4 py-2 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-[#5B45E0] hover:bg-[#4c39c7] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#5B45E0] transition-colors duration-200 flex items-center gap-2"
            >
              <Send className="h-4 w-4" />
              Send Notification
            </button>
      ...
      {activeTab === 'silent' && (
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <div className="px-6 py-4 bg-gradient-to-r from-gray-50 to-white border-b border-gray-100">
              <h2 className="text-lg font-semibold text-gray-900 flex items-center gap-2">
                <Settings className="h-5 w-5 text-[#5B45E0]" />
            ...
            <form onSubmit={handleSilentSubmit} className="p-6 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    id="componentName"
                    name="componentName"
                    value={silentFormData.componentName}
                ...
                <div>
                  ...
                  <textarea
                    id="json"
                    name="json"
                    value={silentFormData.json}
                    onChange={handleSilentChange}
                    rows="4"
                    className="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-[#5B45E0] focus:border-[#5B45E0] sm:text-sm font-mono transition-colors duration-200"
              ...
              <div className="flex justify-end">
                <button
                  type="submit"
                  className="inline-flex items-center px-4 py-2 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-[#5B45E0] hover:bg-[#4c39c7] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#5B45E0] transition-colors duration-200"
                >
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <div className="px-6 py-4 bg-gradient-to-r from-gray-50 to-white border-b border-gray-100">
              <h2 className="text-lg font-semibold text-gray-900 flex items-center gap-2">
                <AlertCircle className="h-5 w-5 text-[#5B45E0]" />
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {componentNotifications.map((notification) => (
